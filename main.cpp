...
int main(int argc, char *argv[]) {
    ...
    if (CommandLineOptions::OPTS_SUCCESS == ret) {
        ...
        tensor_manager_t *tensor_manager = new tensor_manager_t(new Config("/home/sh/vscode/CPUTucker/config.properties"));
        ...
        tensor_manager->WriteTensorBlocksToFile(tensor_blocks);
